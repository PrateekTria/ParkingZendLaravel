...
import com.ticketpro.parking.dar.Enforcement;
...
import com.ticketpro.vendors.SpPlusZoneActivity;
...
*/
        ...
        mOk.setOnClickListener(v -> {
            ...
            if (placard1 != null && !TextUtils.isEmpty(placard1.getPlacardNo())) {
                ...
                new AlertDialog.Builder(WriteTicketActivity.this)
                        ...
                        .setNegativeButton("Cancle", (dialogInterface, i) -> dialog.dismiss())
                        .show();
            } else {
    ...
    public void populateValues(Ticket ticket, boolean isLookupRequired) {
       ...
       // tmEditText.setText(StringUtil.getDisplayString(todayAsString));
        // Apply IDs and Codes
...
// Convert hour and minute into milliseconds
            long currentTimeInMillis = (currentHour * 60 * 60 * 1000) + (currentMinute * 60 * 1000);
...
*/
        ...
        try {
			...
			/*if (Feature.isRequiredField("plate") && plate.equals("")) {
               ...
               /* if (plate.equalsIgnoreCase("NOPLATE") || plate.equalsIgnoreCase("VIN") ||
                ...
                if (plate.isEmpty() && !TPUtility.PlateVINValidate(vin, false)) {
                ...
                if (!plate.isEmpty() && !TPUtility.PlateVINValidate(vin, true)) {
        ...
        try {
            if (!isServiceAvailable) {
                ...
                if (gpsLocation != null && gpsLocation.hasAccuracy()) {
                    activeTicket.setLatitude(lattitude + "");
                    activeTicket.setLongitude(longittude + "");
                }
                ...
                if (gpsLocation != null && gpsLocation.hasAccuracy()) {
                    ...
                    if (isServiceAvailable && gps_enabled) {
                        ...
                        if (lat != null && !TextUtils.isEmpty(lat)) {
                            activeTicket.setLatitude(String.valueOf(lattitude));
                            activeTicket.setLongitude(String.valueOf(longittude));
                        } else {
                            activeTicket.setLatitude("");
                            activeTicket.setLongitude("");
                        }
    ...
    private void processAction(String action) {
        ...
        if (action.equals("Turn Off SpPlus")) {
            TPApp.enableSpPlus = false;
            new Handler().postDelayed(() -> {
                SharedPreferences mPreferences = getSharedPreferences(getPackageName(), MODE_PRIVATE);
                SharedPreferences.Editor editor = mPreferences.edit();
                editor.putBoolean(TPConstant.PREFS_KEY_ENABLE_SAMTRANS, false);
        ...
        if (action.equals("Turn On SpPlus")) {
            TPApp.enableSpPlus = true;
            new Handler().postDelayed(() -> {
                SharedPreferences mPreferences = getSharedPreferences(getPackageName(), MODE_PRIVATE);
                SharedPreferences.Editor editor = mPreferences.edit();
                editor.putBoolean(TPConstant.PREFS_KEY_ENABLE_SP_PLUS, true);
                editor.commit();
            }, 500);
            return;
        }
        ...
        if (action.equals("Chalk Vehicle"))
        {
            ChalkVehicle chalk = TPApp.createNewChalk();
            TPApp.setActiveChalk(chalk);
            Intent i = new Intent();
    ...
    private void createNewTicket() {
        if (activeTicket.getTicketSource() != TicketSource.LPR_NOTIFICATION) {
            ...
            if (activeTicket.isChalked() && Feature.isFeatureAllowed(Feature.RETURN_TO_CHALK)) {
                ...
                if (activeTicket.getTicketViolations().size() == 1 || !TPApp.showPrintDialog) {
                    backToChalkScreen();
                    return;
                }
            }
...
*/
    ...
    private void checkZones() {
        ...
        } if (Feature.isFeatureAllowed(Feature.PARK_SP_PLUS) && TPApp.enableSpPlus) {
            _aListOfEnableService.add(Feature.PARK_SP_PLUS);
        }
        ...
        if (_aListOfEnableService.size() > 1) {
            ...
            builder.setItems(stringArray, (dialog, which) -> {
                ...
                else if (strName.equals(Feature.PARK_SP_PLUS) && TPApp.enableSpPlus) {
                    intent.setClass(WriteTicketActivity.this, SpPlusZoneActivity.class);
                    startActivity(intent);
                }
            });
            ...
            if (Feature.isFeatureAllowed(Feature.PARK_MOBILE) && TPApp.enableParkMobile) {
                ...
                intent.setClass(WriteTicketActivity.this, SamtransZoneActivity.class);
                startActivity(intent);
            }else if (Feature.isFeatureAllowed(Feature.PARK_SP_PLUS) && TPApp.enableSpPlus) {
                intent.setClass(WriteTicketActivity.this, SpPlusZoneActivity.class);
                startActivity(intent);
            } else {
...
/*			//Setting to process files from import folder
	...
	*/
    ...
    public void callTaskReport(String startTime, String endTime, String id, String TaskRecordId, String taskid) throws IOException {
        progressDialog = ProgressDialog.show(WriteTicketActivity.this, "", "Please Wait...");
    ...
    private void startLocationUpdates() {
        ...
        fusedLocationClient1.requestLocationUpdates(locationRequest, locationCallback, null);
    }
    ...
    private void __getGpsLocationFromApi(double latitude, double longitude) {
        ...
        locationPram.setLat(String.valueOf(lattitude));
