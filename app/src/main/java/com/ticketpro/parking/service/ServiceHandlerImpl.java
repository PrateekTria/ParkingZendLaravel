...
public class ServiceHandlerImpl implements ServiceHandler {
    ...
    public boolean syncDevices(JSONArray devices) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncDevices");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncUserSettings(JSONArray settings) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncUserSettings");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncUpdatesTickets(JSONArray tickets) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncUpdatesTickets");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncTicketComments(int violationId, JSONArray comments) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncTicketComments");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncTicketViolations(JSONArray violations) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncTicketViolations");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncTicketPictures(JSONArray pictures) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncTicketPictures");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncChalks(JSONArray chalks) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"), "syncChalks");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncChalkPictures(JSONArray chalkPictures) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncChalkPictures");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncChalkComments(JSONArray chalkComments) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncChalkComments");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncDutyReports(JSONArray dutyReports) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncDutyReports");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncCallInReports(JSONArray callInReports) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncCallInReports");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncHotListReports(JSONArray hotListReports) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncHotListReports");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncSpecialActivityReports(JSONArray specialActivityReports) {
        if (specialActivityReports.length()==0){
            return false;
        }
        JSONObject params = new JSONObject();
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncSpecialActivityReports");
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncSpecialActivityPicture(JSONArray specialActivityReports) {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"syncSpecialActivityPicture");
                return false;
            } else {
                return true;
            }
    ...
    public boolean updateGCMRegistrationId(String deviceName, String registrationId) throws Exception {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"updateGCMRegistrationId");
                return false;
            } else {
                return true;
            }
    ...
    public boolean sendMobileNowLog(ArrayList<MobileNowLog> logs) throws Exception {
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"sendMobileNowLog");
                return false;
            } else {
                return true;
            }
    ...
    public boolean updateChalkStatus(long chalkId, String status, String dispositionReason) throws Exception {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"updateChalkStatus");
                return false;
            } else {
                return true;
            }
    ...
    public boolean updateTicketComments(int violationId, ArrayList<TicketComment> ticketComments) throws Exception {
        try {
            ...
            JSONObject result = getServiceClient().callJSONObject("updateTicketComments", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"updateTicketComments");
                return false;
            } else {
                return true;
            }
    ...
    public boolean deleteTicketComments(long citationNumber, int violationId, String comment) throws Exception {
        ...
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"deleteTicketComments");
                return false;
            } else {
                return true;
            }
    ...
    public boolean deleteTicketPicture(long citationNumber, String imageName) throws Exception {
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"deleteTicketPicture");
                return false;
            } else {
                return true;
            }
    ...
    public boolean updateTicketPicture(long citationNumber, TicketPicture picture) throws Exception {
        try {
            ...
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError"),"updateTicketPicture");
                return false;
            } else {
                return true;
            }
    ...
    private void sendError( String message,String serviceError) {
        try {
            ...
            error.setErrorDesc(message+" Function: "+serviceError);
            error.setErrorType("Service Error Edar");
