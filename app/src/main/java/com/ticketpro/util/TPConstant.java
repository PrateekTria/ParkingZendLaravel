...
public class TPConstant {
    ...
    public static final String PP2 = "https://api.us.passportinc.com/v3/shared";
    public static final String CURRENT_SP_PLUS_ZONE = "sp_plus_zone";
    ...
    public static final String PREFS_KEY_ENABLE_SP_PLUS = "sp_plus";
